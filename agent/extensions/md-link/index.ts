...
export default function (pi: ExtensionAPI) {
  ...
  (globalThis as any).__pi_extension_features?.push({
    name: "md-link",
    description: "Link a .md file for collaborative editing — agent responses append to file, user edits send back via /send-diff",
    commands: ["/link-md", "/unlink-md", "/send-diff", "/sd"],
  });
