  ...
  pi.registerCommand("learn-memory-tool", {
    ...
    handler: async (_args, ctx: ExtensionCommandContext) => {
      ...
      if (section === "What Gets Saved") {
        ...
        lines.push("  Failures        │ failures.md   │ 10,000 chars");
      ...
      if (section === "Architecture") {
        lines.push("");
        lines.push("  ╔══════════════════════════════════════════════╗");
        lines.push("  ║          Two-Tier Architecture               ║");
        lines.push("  ╚══════════════════════════════════════════════╝");
        lines.push("");
