...
export function setupBackgroundReview(
  ...
  pi.on("turn_end", async (event, ctx) => {
    ...
    // Hard timeout watchdog — if subprocess hangs without rejecting,
    // clear the reviewInProgress flag after HARD_TIMEOUT_MS
