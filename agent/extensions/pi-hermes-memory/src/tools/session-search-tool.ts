...
- delta`,
    ...
    execute: withDurationCapture(async (_id: string, args: { markdown: string }) => {
...
Returns conversation snippets with session dates and project context.`,
    ...
    execute: withDurationCapture(async (_id: string, args: { query: string; project?: string; role?: string; limit?: number }) => {
